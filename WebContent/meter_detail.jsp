	...
	<div class="meter_detail_wrap">
		...
		<div class="meter_detail_title_wrap">	
			<div >
				<p class="meter_detail_title_name">
					<div class="meter_detail_title_name_strong">[냉장]돼지고기 다짐육(한돈)</div>
					<div class="meter_detail_title_name_span">명품한돈 신선한 다짐육 (200g)</div>
				</p>
				<p class="meter_detail_title_price">
					3,000<span style="font-size: 15px; font-weight: normal;">원</span>
				</p>
			...
			<div class="meter_detail_title_box">
				<dl class="meter_detail_title_box_dl">
					<dt><span>[냉장]돼지고기 다짐육(한돈)</span> </dt>
					<dd class="meter_detail_title_count_wrap">
						<input type="button" value="-" class="m_title_count">
						<input type="text" value="1" class="m_title_count_num">
						<input type="button" value="+" class="m_title_count">
					</dd>
				</dl>
			</div>
			<div class="meter_detail_buy_wrap">
				<div class="meter_detail_title_total">
					...
					<span class="mdtt_span2"><strong>3,000</strong> 원</span>
				</div>
				<div>
					<a href="basket.jsp"><button class="mdtt_but1">장바구니</button></a>
					<a href="order.jsp"><button class="mdtt_but2">바로구매</button></a>
				</div>
			</div>
			</div>
		</div>	
		...
		<div class="meter_detail_conwrap">
				...
				<div class="me_d_cdetail">
					<img alt="다짐육_상세설명 " src="img/chop_pig_detail.jpg" style="border: 1px solid #cccccc; width: 900px; height: 1400px;">
				</div>
				<ul>
					<li class="mdc_suv"><a>관련레시피</a></li>
					<li class="mdc_suv"><a>상세정보</a></li>
				...
				<div class="me_d_cbuy">
					<img alt="구매설명" src="img/buydetail.PNG" style="width: 900px;">
				</div>
