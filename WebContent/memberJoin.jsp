...
function btn(sample){
	alert(sample);
	document.location.href="administratorLogin.jsp";
}
function openIdChk(){
...
<body>
  ...
  <div class="login-form">
    <h2 align="center">Member Join</h2>
    <form>
      <a class="i_d">아이디</a>
      ...
      <a class="dat">생년월일</a>
        ...
        <a class="gender">여</a>
	      ...
	      <input type="button" class="join" value="가입하기" onclick="javascript:btn('관리자가입이 완료되었습니다.')">
